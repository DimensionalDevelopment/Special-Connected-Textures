...
public class SpecialTextures implements ModInitializer {
	...
	public static final SpecialModelRenderer CTM_FULL = Registry
		.register(SpecialModelRenderer.SPECIAL_MODEL_RENDERER, new Identifier("speconnectures", "ctm_full"),
			new CtmFullRenderer());

	public static final SpecialModelRenderer CTM_COLUMN = Registry
		.register(SpecialModelRenderer.SPECIAL_MODEL_RENDERER, new Identifier("speconnectures", "ctm_column"),
			new CtmColumnRenderer());

	public static final SpecialModelRenderer CTM_ROW = Registry
		.register(SpecialModelRenderer.SPECIAL_MODEL_RENDERER, new Identifier("speconnectures", "ctm_row"),
			new CtmRowRenderer());

	public static final SpecialModelRenderer CTM_FULL_ROW = Registry
		.register(SpecialModelRenderer.SPECIAL_MODEL_RENDERER, new Identifier("speconnectures", "ctm_full_row"),
			new CtmFullRowRenderer());

	public static final SpecialModelRenderer CTM_FULL_COLUMN = Registry
		.register(SpecialModelRenderer.SPECIAL_MODEL_RENDERER, new Identifier("speconnectures", "ctm_full_column"),
			new CtmFullColumnRenderer());

	public static final SpecialModelRenderer CTM_TILE = Registry
		.register(SpecialModelRenderer.SPECIAL_MODEL_RENDERER, new Identifier("speconnectures", "ctm_tile"),
			new CtmTileRenderer());
